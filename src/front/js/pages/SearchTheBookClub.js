...
const Inquistivo = () => {
  ...
  return (
    <div>
      ...
      cientos de veces". "Entonces, ¿cuántos hay?" "¿Cuántos? No sé." “¡Así es!
      No has observado. Y, sin embargo, has visto: 'Ese es solo mi punto. Ahora,
      sé que hay diecisiete pasos, porque he visto y observado. Por cierto, dado
      que estás interesado en estos pequeños problemas, y dado que eres lo
      suficientemente bueno como para relatar una o dos de mis insignificantes
      experiencias, es posible que te interese esto. Arrojó una hoja de papel
      grueso, teñido de rosa, que había estado abierta sobre la mesa. “Llegó con
      el último correo”, dijo. " Léelo en voz alta." La nota no tenía fecha ni
      firma ni dirección. “Te visitará esta noche, a las ocho menos cuarto”,
      decía, “un caballero que desea consultarte sobre un asunto de suma
      importancia. Sus recientes servicios a una de las casas reales de Europa
